 ...
 *
 */
public class ETCTradeListValidator implements DuplicationalValidator<String> {

	
	private static final String indexName = "po_02";
	
	private static final String esType = "etcTradeList";
